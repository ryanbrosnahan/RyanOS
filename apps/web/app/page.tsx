...
const buildSlices = [
  {
    title: "Current slice",
    body: "Workspace, API, worker, database schema, AI tool registry, recurrence core, dashboard shell, Docker dev environment, Postgres store adapter, and persisted inbound messages."
  },
  {
    title: "Next slice",
